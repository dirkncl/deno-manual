...
[local and remote import examples](./examples/import_export.md). But in this case instead
...
[Fetch data →](./examples/fetch_data.md)[← Import and export modules](./examples/import_export.md)