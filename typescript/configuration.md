...
[Type Checking Web Workers](./typescript/types.md#type-checking-web-workers) for more
information on this.
...
- `"deno.worker"` - This is the library used when checking a Deno web worker
  ...
  [Type Checking Web Workers](./typescript/types.md#type-checking-web-workers).
...
on this see
[Using ambient or global types](./typescript/types.md#using-ambient-or-global-types).

[Types and type declarations →](./typescript/types.md)[← Overview](./typescript/overview.md)